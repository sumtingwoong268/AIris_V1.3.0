...
export const ThemeToggle = () => {
  ...
  return (
    <div ref={containerRef} className="pointer-events-auto flex flex-col items-end gap-2 text-right">
      <button
        type="button"
      ...
      {open && (
        <div
          className="animate-in fade-in zoom-in-95 origin-top-right rounded-2xl border border-border/70 bg-white/95 p-3 shadow-xl backdrop-blur dark:border-slate-700 dark:bg-slate-900/90"
        >
